...
import Approved from './pages/AllApprovedRequests'
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <PrivateRoute>
            {getUserRoleFromToken() === 'Admin' || getUserRoleFromToken() === 'It' ? <Stocks /> : <Navigate to="/home" replace />}
          </PrivateRoute>
        }
      />
      <Route
        ...
        element={
          <PrivateRoute>
            {getUserRoleFromToken() === 'Admin' ? <Approved /> : <Navigate to="/home" replace />}
          </PrivateRoute>
        }
      />
    </Routes>
